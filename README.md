...
下の層から積み上げる方針。**認証は最後**に回し、Todo CRUD → AI生成を先に作る。

| #  | ステップ                          | 状態      |
| -- | --------------------------------- | --------- |
| -  | 土台構築（Next.js 16 / Tailwind 4 / TS） | ✅ 完了   |
| -  | データ層（Supabase / Prisma / スキーマ・マイグレーション） | ✅ 完了   |
| 1  | Prisma client を繋ぐ              | ⬜ 未着手 |
| 2  | Todo CRUD API を作る              | ⬜ 未着手 |
| 3  | DBに繋ぐ                          | ⬜ 未着手 |
| 4  | API を叩いて動作検証              | ⬜ 未着手 |
| 5  | UIと繋ぐ                          | ⬜ 未着手 |
| 6  | AIに食わせるデータをまとめる      | ⬜ 未着手 |
| 7  | AIにPOST（タイムライン生成）      | ⬜ 未着手 |
| 8  | completion表示画面を作る          | ⬜ 未着手 |
| 9  | 認証（Supabase Auth / middleware）| ⬜ 未着手 |
